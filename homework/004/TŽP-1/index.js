...
if (pilkis > murklys) {
    console.log(`Pilkis ${pilkis} kg, Murklys: ${murklys} kg. Murklys`);
} else if (pilkis < murklys) {
    console.log(`Pilkis ${pilkis} kg, Murklys: ${murklys} kg. Pilkis`);
} else {
...
Vienoje telpa 15 katinukų, kitoje 15 karvių (katinukus galima sodinti tik į katinukų valtis, o karves tik į karvių, maišyti negalima
